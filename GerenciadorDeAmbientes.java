...
/////////////////////////
    ...
    public boolean getPodeVasculhar()
        { return podeVasculhar; }
    public void setPodeVasculhar()
        { podeVasculhar = true; }
    
    private int limiteDeVasculhar = 5;
    private int quantasVezesVasculhou = 0;
    public int getLimiteDeVasculhar()
        { return limiteDeVasculhar; }
